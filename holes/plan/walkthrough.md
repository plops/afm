...
This report summarizes the analysis of the Coordinate Measuring Machine (CMM) hole grid measurements in [DrillData.xlsx](file:///home/kiel/stage/afm/holes/DrillData.xlsx) (unrotated) and [DrillRot90_2.xlsx](file:///home/kiel/stage/afm/holes/DrillRot90_2.xlsx) (rotated 90° clockwise).
...
### File Orientations:
- **[DrillData.csv](file:///home/kiel/stage/afm/holes/DrillData.csv) (Unrotated):** Measured with the plate aligned with the CMM:
  - $X_{CMM} = u$, $Y_{CMM} = v$
- **[DrillRot90_2.csv](file:///home/kiel/stage/afm/holes/DrillRot90_2.csv) (Rotated 90° CW):** Measured with the plate rotated 90° clockwise:
...
![CMM Calibration Parameters](/home/kiel/.gemini/antigravity/brain/64364808-2f85-499b-bf2f-0fcbd61b511f/cmm_calibration_parameters.png)
...
![CMM Drift and Deviations](/home/kiel/.gemini/antigravity/brain/64364808-2f85-499b-bf2f-0fcbd61b511f/cmm_drift_and_deviations.png)
...
- [global_calibration_results.csv](file:///home/kiel/stage/afm/holes/global_calibration_results.csv): Table of calibration parameters and drift rates for all 8 blocks.
- [calibrated_physical_deviations.nc](file:///home/kiel/stage/afm/holes/calibrated_physical_deviations.nc): A netCDF dataset (xarray-compatible) containing the true, drift-corrected coordinate deviations $(\Delta u, \Delta v)$ for all 943 holes across all 8 runs.
